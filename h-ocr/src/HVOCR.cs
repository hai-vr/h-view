...
public class HVOcr
{
    ...
    public static async Task<string[]> FindLobbyCodesInScreenshot(SoftwareBitmap bitmap)
    {
        ...
        var ocrResult = await langToEngine[lang].RecognizeAsync(bitmap);
    ...
    public static SoftwareBitmap OpenBytes(byte[] bytes, int width, int height)
    {
    ...
    private static async Task debugwritetofile(SoftwareBitmap softwareBitmap)
    {
        try
        {
