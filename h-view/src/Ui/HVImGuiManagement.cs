...
public class HVImGuiManagement : IDisposable
{
    ...
    private HVInnerWindow.HPanel _panel = HVInnerWindow.HPanel.Shortcuts;
    private bool _debugTransparency;

    public HVImGuiManagement(HVRoutine routine, bool isWindowlessStyle, int windowWidth, int windowHeight, int innerWidth, int innerHeight, SavedData config)
    {
        _routine = routine;
    ...
    private void SubmitUI()
    {
        ...
        ShowSidebarButton(buttonSize, HLocalizationPhrase.ShortcutsTabLabel, HVInnerWindow.HPanel.Shortcuts);
        ShowSidebarButton(buttonSize, HLocalizationPhrase.CostumesTabLabel, HVInnerWindow.HPanel.Costumes);
        if (_networkingTabOptional != null) ShowSidebarButton(buttonSize, HLocalizationPhrase.NetworkingTabLabel, HVInnerWindow.HPanel.Networking);
        ShowSidebarButton(buttonSize, HLocalizationPhrase.ParametersTabLabel, HVInnerWindow.HPanel.Parameters);
        if (ConditionalCompilation.IncludesOpenVR) ShowSidebarButton(buttonSize, HLocalizationPhrase.HardwareTabLabel, HVInnerWindow.HPanel.Hardware);
        ShowSidebarButton(buttonSize, HLocalizationPhrase.OptionsTabLabel, HVInnerWindow.HPanel.Options);
        ShowSidebarButton(buttonSize, HLocalizationPhrase.TabsTabLabel, HVInnerWindow.HPanel.Tabs);
        ...
        else
        {
            ...
            {
                _panel = HVInnerWindow.HPanel.Options;
            }
        }
    ...
    private void ShowSidebarButton(Vector2 buttonSize, string label, HVInnerWindow.HPanel target)
    {
    ...
    private void SwitchPanel(HVInnerWindow.HPanel newPanel)
    {
        _panel = newPanel;
    }
